...
async def update_progress(user_id, message_id, results, current_attempt_count):
    ...
    progress_text = f"""💳 Cᴀʀᴅ: <code>{results.get('last_card', 'None')[:10]}</code>
📝 {results.get('last_response', 'Waiting...')[:10]}
